...
a=h.hasClass("template-download")?"download":"upload";var f=d.editModalId,g=d.editModalImgId;if("upload"===a){var l=h.data("data");if(!l){c.prop("disabled",!0);return}var m,k=l.files[0];b.each(l.originalFiles,function(a,b){if(b.name===k.name)return m=b,!0});if(!m)return;g.prop("src",loadImage.createObjectURL(m));g.processCroppedCanvas=function(a){f.modal("hide");d.cropperButtonSelector.prop("disabled",!0);h.find(".btn").prop("disabled",!0);a.toBlob(function(a){a.name=k.name;d.maxNumberOfFiles++;e.fileupload("add",
{files:[a],replaceChild:b(l.context)});d.maxNumberOfFiles--},m.type)}}"download"===a&&(g.attr("src",c.data("src")),g.submitData=function(a){var n=d.cropperResultMessageBoxSelector;d.cropperButtonSelector.prop("disabled",!0);g.cropper("disable");b.ajax({method:"POST",url:c.data("action"),data:JSON.stringify(a),beforeSend:function(a,b){a.setRequestHeader("X-CSRFToken",c.data("data"))}}).always(function(){}).done(function(a){d.done.call(e,b.Event("done"),{result:{files:[a.file]},context:c.closest(".template-download")});
n.html("<span class='alert alert-success'>"+a.message+"</span>");f.data("new",!1);setTimeout(function(){f.data("new")||f.modal("hide")},3E3)}).fail(function(a){n.html("<span class='alert alert-danger'>"+a.responseJSON.message+"</span>")});return!1});g.rotateCanvas=function(){var a=b(this),c=a.cropper("getContainerData"),f=a.cropper("getCanvasData"),e=c.height/f.height*f.width;e>=c.width?(f=c.width/f.width*f.height,c={height:f,width:c.width,top:(c.height-f)/2,left:0}):c={height:c.height,width:e,top:0,
left:(c.width-e)/2};a.cropper("setCanvasData",c).cropper("setCropBoxData",c);d.cropperButtonSelector.prop("disabled",!1)};f.modal("show",[g,a])},_initEditModalId:function(){var a=this.options;a.editModalId===e?a.editModalId=this.element.find("#editModal"):a.editModalId instanceof b||(a.editModalId=b(a.editModalId))},_initEditModalImgId:function(){var a=this.options;a.editModalImgId===e?a.editModalImgId=this.element.find("#modalImage"):a.editModalImgId instanceof b||(a.editModalImgId=b(a.editModalImgId))},
_initCropperResultMessageBoxSelector:function(){var a=this.options;a.cropperResultMessageBoxSelector===e?a.cropperResultMessageBoxSelector=this.element.find("#cropper-message"):a.cropperResultMessageBoxSelector instanceof b||(a.cropperResultMessageBoxSelector=b(a.cropperResultMessageBoxSelector))},_initCropperButtonDivSelector:function(){var a=this.options;a.cropperButtonDivSelector===e?a.cropperButtonDivSelector=this.element.find(".cropper-btns"):a.cropperButtonDivSelector instanceof b||(a.cropperButtonDivSelector=
b(a.cropperButtonDivSelector))},_initCropperButtonSelector:function(){var a=this.options;a.cropperButtonSelector=a.cropperButtonDivSelector.find(".btn")},_initCropperStatusBtnSelector:function(){var a=this.options;a.cropperStatusBtnSelector===e?a.cropperStatusBtnSelector=this.element.find(".cropper-status-btns .btn"):a.cropperStatusBtnSelector instanceof b||(a.cropperStatusBtnSelector=b(a.cropperStatusBtnSelector))},_initCropperRotateBtnSelector:function(){var a=this.options;a.cropperRotateBtnSelector===
e?a.cropperRotateBtnSelector=this.element.find(".cropper-rotate-btns .btn"):a.cropperRotateBtnSelector instanceof b||(a.cropperRotateBtnSelector=b(a.cropperRotateBtnSelector))},_initEditModalEventHandler:function(){var a=this,c=a.options,d,e,h;this.options.editModalId.on("show.bs.modal",function(a){d=a.relatedTarget[0];e=a.relatedTarget[1]}).on("shown.bs.modal",function(){b(this).data("new",!0);a._trigger("modalshownevent",event,!0);d.cropper({viewMode:1,checkOrientation:!1,autoCrop:!0,autoCropArea:1,
strict:!0,movable:!1,zoomable:!1,minContainerheight:.8*b(p).height(),ready:function(a){h=d.cropper("getData","true");c.cropperRotateBtnSelector.prop("disabled",!1)},cropstart:function(c){a._trigger("modalinprogessstatus",event,!0)},crop:function(a){},cropend:function(b){b=d.cropper("getData","true");b=JSON.stringify(h)===JSON.stringify(b);c.cropperStatusBtnSelector.prop("disabled",b);a._trigger("modalinprogessstatus",event,!b)}})}).on("hidden.bs.modal",function(){a._trigger("modalinprogessstatus",
