...
SAVED_QUESTION = "resource_allocation_dp3.bin"

M = 3
N = 6
N_nan = 3
OPT_TYPE = "max"
PROJECT_LIST = [u"销售区域A", u"销售区域B", u"销售区域C"]
...
for i, dp_dict in enumerate(dp_list_loaded):
    ...
    question_template = latex_jinja_env.get_template('final_test_dp_resource_allocation_3.tex')
    #blank_template = latex_jinja_env.get_template('dp_resource_allocation_2_blank.tex')
    answer_template = latex_jinja_env.get_template('/utils/final_test_dynamic_programming_template.tex')
