(function () {
    ...
    $(document).ready(function() {
        $('input[type=checkbox]').change(function () {
            if ($(this).siblings("label").html() === "fullcorrect" || $(this).siblings("label").html() === "完全正确") {
                console.log("changed!!");
            ...
            if ($(this).siblings("label").html() === "--" || $(this).siblings("label").html() ==="---" || $(this).siblings("label").html() ==="----") {
                $(this).parent().siblings().find('[name=' + $(this).attr('name') + ']').each(function () {
                    $(this).prop('checked', false);
                });
            }
            ...
            var numberOfChecked = $('input:checkbox:checked[name=' + $(this).attr('name') + ']').length;
            if (numberOfChecked === 0){
                    console.log("0!!!!");
                    $(this).parent().siblings().andSelf().find('[name=' + $(this).attr('name') + ']').each(function () {
                    if ($(this).siblings("label").html() === "--" || $(this).siblings("label").html() ==="---" || $(this).siblings("label").html() ==="----") {
