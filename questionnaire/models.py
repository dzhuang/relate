...
class QuestionQuerySet(models.QuerySet):
    ...
    def types_mutually_exclusive_answers(self):
        return self.filter(type='MutuallyExclusiveField')
    ...
    def calculate_statistics_mutually_exclusive_answers(self):
        return self._get_statistics_multichoice(
            self.types_mutually_exclusive_answers()
        )
...
class Question(models.Model):
    CHOICES = (('yesNoQuestion',
               ...
               ('MutuallyExclusiveField',
                _('Question with multually exclusive answers'),
                _('The participant is conducted to pick (one or more '
                  'responses) in response options list.'),
                ),
